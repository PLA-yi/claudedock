...
The keys live in `.claude/settings.json` (project) or `/Users/zaneliu/Projects/open-source/claudedock/.cursor/settings.json` (global) — **not** in `.planning/config.json`:
