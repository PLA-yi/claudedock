...
- Usage: Reference from command with `@/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/zaneliu/Projects/open-source/claudedock/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/zaneliu/Projects/open-source/claudedock/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
