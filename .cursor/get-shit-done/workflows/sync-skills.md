...
INSTALL_JS_GLOBAL="/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
