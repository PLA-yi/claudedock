...
<required_reading>
@/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/references/ai-frameworks.md
...
```markdown
Read /Users/zaneliu/Projects/open-source/claudedock/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/zaneliu/Projects/open-source/claudedock/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/zaneliu/Projects/open-source/claudedock/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/zaneliu/Projects/open-source/claudedock/.cursor/agents/gsd-eval-planner.md for instructions.
