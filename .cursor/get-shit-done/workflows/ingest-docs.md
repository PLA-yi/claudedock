...
```bash
INIT=$(node "/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/bin/gsd-tools.cjs" commit \
