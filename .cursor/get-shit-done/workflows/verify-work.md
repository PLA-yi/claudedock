...
<template>
@/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/workflows/transition.md`.
...
- Follow @/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/workflows/diagnose-issues.md
