...
- **Global scope**: `/Users/zaneliu/Projects/open-source/claudedock/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/zaneliu/Projects/open-source/claudedock/.cursor/notes/`)
...
2. Glob `/Users/zaneliu/Projects/open-source/claudedock/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/zaneliu/Projects/open-source/claudedock/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/zaneliu/Projects/open-source/claudedock/.cursor/notes/` — works in any directory
