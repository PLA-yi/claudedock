...
```
Agent(
  prompt="Read /Users/zaneliu/Projects/open-source/claudedock/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/zaneliu/Projects/open-source/claudedock/.cursor/get-shit-done/templates/VALIDATION.md`
