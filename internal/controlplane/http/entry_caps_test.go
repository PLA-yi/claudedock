...
func TestDeriveEntryCapabilities(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			ref:              "ghcr.io/example/claudedock:v3.0.0",
		...
		},
		{
			...
			ref:              "ghcr.io/example/claudedock:v2.0.0",
			imageLockVersion: "v3.0.0",
			wantVersion:      "v2.0.0",
			wantMergerfs:     false,
		},
		{
			...
			ref:              "ghcr.io/example/claudedock:v3.1.0",
		...
		},
		{
			...
			ref:              "ghcr.io/example/claudedock:latest",
			imageLockVersion: "v3.1.0",
			wantVersion:      "latest",
			wantMergerfs:     false,
		},
		{
			...
			ref:              "ghcr.io/example/claudedock:v3.0.0-rc1",
			imageLockVersion: "v3.0.0",
		...
		},
		{
			...
			ref:          "claudedock-image",
			wantVersion:  "claudedock-image",
			wantMergerfs: false,
		},
		{
		...
		},
		{
			...
			ref:              "registry.internal:5000/claudedock:v3.0.0",
			imageLockVersion: "v3.0.0",
			wantVersion:      "v3.0.0",
			wantMergerfs:     true,
		},
