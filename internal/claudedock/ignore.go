// Package claudedock — gitignore-style 忽略规则解析。
//
// 用于把用户工程根目录下的 .gitignore（以及可选的 .claudedock-ignore）喂给
// 两个路径：
...
// DefaultBinaryIgnorePatterns 是 claudedock 内置的"媒体/二进制"扩展名黑名单。
//
// 设计要点：
...
//   - 用户在 .gitignore 或 .claudedock-ignore 用 `!foo.png` 之类 negation 能
