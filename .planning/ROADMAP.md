...
*Last updated: 2026-04-23 — Phase 36 plan 03 completed (hot_sync 单文件熔断 + mount_strategy 持久化), v3.1 milestone in progress. v3.0 phase details see [Archive](milestones/v3.0-ROADMAP.md).*
