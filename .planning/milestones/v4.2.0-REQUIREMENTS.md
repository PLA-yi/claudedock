# Requirements Archive: v4.2.0 容器合并 · SQLite 迁移 · 配置统一
...
- [x] **DEP-01**: docker-compose.yml 移除 postgres、admin、sing-box 三个服务及 claudedock-postgres volume
- [x] **DEP-02**: control-plane 服务改为 DATABASE_URL=file:/data/claudedock.db + ./data:/data volume
