...
### Created
- `internal/claudedock/doctor/remote_ssh_test.go` — 20 个 test cases

### Modified
- `internal/claudedock/errcodes/codes_test.go` — TestPhase41CodesRegistered
- `internal/claudedock/errcodes/explanations_test.go` — TestPhase41ExplainCoverage
...
- [x] `go test ./internal/claudedock/errcodes/...` 全部通过（11 tests）
- [x] `go test ./internal/claudedock/doctor/...` 全部通过
