# Phase 25: claudedock CLI 骨架与连接 - Research
...
- D-01～D-12：cobra、config 路径、Entry auth、轮询、单 PTY session、中文错误与退出码、无硬编码网关默认等 — 见 `.planning/phases/25-claudedock-cli/25-CONTEXT.md`。
</user_constraints>
