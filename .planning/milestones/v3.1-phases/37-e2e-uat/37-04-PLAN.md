...
<task type="auto">
  ...
  <read_first>
    ...
    - internal/claudedock/errcodes/mount.go（5 个错误码的 Message + NextAction 字面量）
  </read_first>
  <action>
...
**注意：** v3.1 不持久化 hot 分支。会话退出后 hot staging 目录被清理，下次 claudedock 需要重新晋升。跨会话持久缓存为 v3.4 评估项。
