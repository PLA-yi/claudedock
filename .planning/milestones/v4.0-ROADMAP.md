...
- ✅ **v2.0 claudedock 透明远程 CLI** — Phases 24-28 (shipped 2026-04-15) — [Archive](milestones/v2.0-ROADMAP.md)
...
**Goal:** control-plane / host-agent 不再创建 gw 容器；`container_proxy_provider` 简化为单容器路径；`claudedock-net-*` 自定义 bridge 退役；双绑互斥契约不变。
...
**Archive reason:** v1.3 的"本地容器"和"指纹伪装"能力与 v3.4 的 `claudedock local` 目标重叠。为避免维护两套本地 Docker 编排逻辑，v1.3 能力拆分并入 v3.4：
...
<details>
<summary>✅ v2.0 claudedock 透明远程 CLI (Phases 24-28) — SHIPPED 2026-04-15</summary>

- [x] Phase 24: 受管镜像 FUSE 硬化与容器参数 (1/1 plans) — completed 2026-04-14
- [x] Phase 25: claudedock CLI 骨架与连接 (1/1 plans) — completed 2026-04-15
...
- [x] Phase 34: claudedock doctor v3 + 错误码统一 (3/3 plans) — completed 2026-04-21
...
| 24-28. v2.0 claudedock | v2.0 | 7/7 | Complete | 2026-04-15 |
